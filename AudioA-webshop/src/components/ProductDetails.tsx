import { ArrowLeft, Check, Star, ShoppingCart, Zap } from 'lucide-react';
          ...
          >
            ...
            >
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <p className="text-lg text-gray-500 line-through">${Math.round(product.price * 1.2)}</p>
